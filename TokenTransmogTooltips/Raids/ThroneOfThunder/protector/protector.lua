...
local hunter = ns._Gear.ThroneOfThunder["HUNTER"]
local warrior = ns._Gear.ThroneOfThunder["WARRIOR"]
local monk = ns._Gear.ThroneOfThunder["MONK"]
local shaman = ns._Gear.ThroneOfThunder["SHAMAN"]

---@class ThroneOfThunderProtector
ns._Gear.ThroneOfThunder["PROTECTOR"] = {
	["NORMAL"] = {
		["HELM"] = {
