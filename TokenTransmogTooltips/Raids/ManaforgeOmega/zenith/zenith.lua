...
---@type ManaforgeOmegaEvoker
local evoker = gear["EVOKER"]
---@type ManaforgeOmegaMonk
local monk = gear["MONK"]
---@type ManaforgeOmegaRogue
local rogue = gear["ROGUE"]
---@type ManaforgeOmegaWarrior
local warrior = gear["WARRIOR"]

---@class ManaforgeOmegaZenith
ns._Gear.ManaforgeOmega["ZENITH"] = {
	["RAID_FINDER"] = {
		["HELM"] = {
