...
---@type Tier14Deathknight
local deathknight = ns._Gear.tier14["DEATHKNIGHT"]

---@type Tier14Druid
local druid = ns._Gear.tier14["DRUID"]

---@type Tier14Mage
local mage = ns._Gear.tier14["MAGE"]

---@type Tier14Rogue
local rogue = ns._Gear.tier14["ROGUE"]

---@class Tier14Vanquisher
ns._Gear.tier14["VANQUISHER"] = {
	["NORMAL"] = {
		["HELM"] = {
