...
mergeTable(RAID_FINDER_DEATHKNIGHT_GEAR, ns._Gear.VotI["DEATHKNIGHT"]["RAID_FINDER"]["HELM"])
...
mergeTable(NORMAL_DEATHKNIGHT_GEAR, ns._Gear.VotI["DEATHKNIGHT"]["NORMAL"]["HELM"])
...
mergeTable(HEROIC_DEATHKNIGHT_GEAR, ns._Gear.VotI["DEATHKNIGHT"]["HEROIC"]["HELM"])
...
mergeTable(MYTHIC_DEATHKNIGHT_GEAR, ns._Gear.VotI["DEATHKNIGHT"]["MYTHIC"]["HELM"])
