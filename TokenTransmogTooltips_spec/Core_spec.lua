...
describe("Core.lua GetTooltipInfo", function()
	before_each(function()
		...
		_G.TokenTransmogTooltipsDB = {}
		_G.C_TransmogCollection.PlayerHasTransmogItemModifiedAppearance = function()
			return false
		end
		_G.C_TransmogCollection.GetAllAppearanceSources = function(appId)
			return { appId * 10 }
		end
	...
	describe("async link loading", function()
		it("returns linksReceived=false when GetAllAppearanceSources returns empty", function()
			_G.C_TransmogCollection.GetAllAppearanceSources = function()
				return {}
			end
		...
		it("returns linksReceived=false when GetAppearanceSourceInfo returns nil", function()
			_G.C_TransmogCollection.GetAppearanceSourceInfo = function()
				return nil
			end
